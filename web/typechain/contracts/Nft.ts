...
export interface NftInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getTokenIdByProjectAndJob",
...
export interface Nft extends BaseContract {
  ...
  getTokenIdByProjectAndJob: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "getTokenIdByProjectAndJob"
  ): TypedContractMethod<
    [projectId: BigNumberish, jobId: BigNumberish],
    [bigint],
    "view"
